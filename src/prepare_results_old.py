    ...
    def prepareRegularList(self):
        try:
            ...
            for prod in productFinal:
                ...
                product['nm'] = "<a href=\"http://www.decathlon.pl"+prod['url']+"\">"+name+"</a>"+"<br><img src=\"http://www.decathlon.pl{}\">".format(prod['img'])
                # product['im'] = '<img src="http://www.decathlon.pl{}">'.format(prod['img'])
                product['rl'] = prod['url']
